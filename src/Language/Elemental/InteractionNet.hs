...
data INetF a
    ...
    | LamNode a a a
    -- | (a, a, a)
    | DupNode DupKind Level Renames a a a
    -- | Void (i.e. any type)
    | DeadNode a
    -- FFI
    -- | IO i{n}
...
instance Pretty a => Pretty (INetF a) where
    ...
    pretty (DupNode dk lvl _ r0 r1 r2)
        = "Dup" <+> pretty dk <+> pretty lvl
        <+> pretty r0 <+> pretty r1 <+> pretty r2
...
data DupKind = Fanin | Fanout
    deriving stock (Eq, Ord)

instance Pretty DupKind where
    pretty Fanin = "Fanin"
    pretty Fanout = "Fanout"
...
reduceNode (AppNode _ r0 r1) (LamNode _ r2 r3)
    = linkNodes r0 r2 *> linkNodes r1 r3
reduceNode n0@LamNode {} n1@AppNode {} = reduceNode n1 n0
reduceNode (AppNode _ r0 r1) (DupNode Fanin lvl re _ r2 r3) = commute2'
    AppNode AppNode (DupNode Fanout lvl re) (DupNode Fanin lvl re) r0 r1 r2 r3
reduceNode n0@DupNode {} n1@AppNode {} = reduceNode n1 n0
reduceNode (LamNode _ r0 r1) (DupNode Fanout lvl re _ r2 r3) = commute2'
    LamNode LamNode (DupNode Fanin lvl re) (DupNode Fanout lvl re) r0 r1 r2 r3
reduceNode n0@DupNode {} n1@LamNode {} = reduceNode n1 n0
reduceNode (DupNode Fanout lvl1 re1 (Ref idx1 _) r0 r1)
    (DupNode Fanin lvl2 re2 (Ref idx2 _) r2 r3)
    | lvl1 == lvl2 = linkNodes r0 r2 *> linkNodes r1 r3
    | otherwise = commute2'
        (DupNode Fanout lvl11 re1) (DupNode Fanout lvl12 re1)
        (DupNode Fanin lvl2 re2) (DupNode Fanin lvl2 re2)
        r0 r1 r2 r3
  where
    lvl11 = Level $ idx1 : unLevel lvl1
    lvl12 = Level $ idx2 : unLevel lvl1
reduceNode n0@(DupNode Fanin _ _ _ _ _) n1@(DupNode Fanout _ _ _ _ _)
    = reduceNode n1 n0
...
reduceNode (DupNode _ _ _ _ r0 r1) (DeadNode _) = propagate2 r0 r1 DeadNode
...
reduceNode (Branch3PNode lvl opc _ r0 r1) (AppNode _ r2 r3) = do
    ...
    rn6 <- newNode $ \rn6 -> DupNode Fanout (Level [rn6]) mempty () () ()
...
-- FFI Duplication
reduceNode (DupNode Fanout _ re _ r0 r1) (OperandNode op _)
    = copyIO1 r0 r1 OperandNode B.renameOp re op
reduceNode n0@OperandNode {} n1@DupNode {} = reduceNode n1 n0
reduceNode (DupNode Fanin lvl re _ r0 r1) (OperandPNode opp _ r2)
    = copyIO2 Fanin lvl r0 r1 r2 OperandPNode (fmap . B.renameOp) re opp
reduceNode n0@OperandPNode {} n1@DupNode {} = reduceNode n1 n0
reduceNode (DupNode Fanin lvl re _ r0 r1) (IOPNode iop _ r2)
    = copyIO2 Fanin lvl r0 r1 r2 IOPNode (fmap . B.renameInstr) re iop
reduceNode n0@IOPNode {} n1@DupNode {} = reduceNode n1 n0
reduceNode (DupNode Fanout lvl re _ r0 r1) (IOContNode nbs _ r2)
    = shareIOCont lvl re nbs r0 r1 r2
reduceNode n0@IOContNode {} n1@DupNode {} = reduceNode n1 n0
reduceNode (DupNode Fanin lvl re _ r0 r1) (Pure0Node _ r2)
    = commute1 (DupNode Fanin lvl re) Pure0Node r0 r1 r2
reduceNode n0@Pure0Node {} n1@DupNode {} = reduceNode n1 n0
reduceNode (DupNode Fanin lvl re _ r0 r1) (Bind0Node _ r2)
    = commute1 (DupNode Fanin lvl re) Bind0Node r0 r1 r2
reduceNode n0@Bind0Node {} n1@DupNode {} = reduceNode n1 n0
reduceNode (DupNode Fanin lvl re _ r0 r1) (Bind1Node nbs _ r2)
    = shareBind1 lvl re nbs r0 r1 r2
reduceNode n0@Bind1Node {} n1@DupNode {} = reduceNode n1 n0
reduceNode (DupNode Fanin lvl0 re _ r0 r1) (Branch0Node lvl1 _ r2)
    = commute1 (DupNode Fanin lvl0 re) (Branch0Node lvl1) r0 r1 r2
reduceNode n0@Branch0Node {} n1@DupNode {} = reduceNode n1 n0
reduceNode (DupNode Fanin lvl0 re _ r0 r1) (Branch1Node lvl1 op _ r2)
    = copyIO2 Fanin lvl0 r0 r1 r2 (Branch1Node lvl1) B.renameOp re op
reduceNode n0@Branch1Node {} n1@DupNode {} = reduceNode n1 n0
reduceNode (DupNode Fanin lvl0 re _ r0 r1) (Branch2BNode lvl1 opc nbt _ r2 r3)
    = shareBranch2B lvl0 lvl1 re opc nbt r0 r1 r2 r3
reduceNode n0@Branch2BNode {} n1@DupNode {} = reduceNode n1 n0
reduceNode (DupNode Fanin lvl0 re _ r0 r1) (Branch2PNode lvl1 op _ r2 r3)
    = commute2' (DupNode Fanout lvl0 re) (DupNode Fanin lvl0 re)
...
reduceNode (DupNode Fanout lvl0 re _ r0 r1) (Branch3PNode lvl1 op _ r2 r3)
    = commute2' (DupNode Fanout lvl0 re) (DupNode Fanout lvl0 re)
...
copyIO2
    :: HasRewriter sig m
    => DupKind -> Level -> Ref -> Ref -> Ref -> (a -> () -> () -> INetF ())
    -> (M.Map B.Name B.Operand -> a -> a) -> Renames -> a
    -> m ()
copyIO2 dk lvl r0 r1 r2 mk1 f re ffi = commute1' (DupNode dk lvl re)
...
copyIO3
    :: HasRewriter sig m
    => DupKind -> DupKind -> Level -> Ref -> Ref -> Ref -> Ref
    -> (a -> () -> () -> () -> INetF ())
    -> (M.Map B.Name B.Operand -> a -> a) -> Renames -> a
    -> m ()
copyIO3 dk1 dk2 lvl r0 r1 r2 r3 mk1 f re ffi = commute2'
    (DupNode dk1 lvl re) (DupNode dk2 lvl re)
    (mk1 $ f (M.map fst re) ffi)
...
shareIOCont = sharePreaction (<>) (pure pure) (pure pure) IOContNode Fanout
...
shareBind1
    ...
    => Level -> Renames -> Preaction -> Ref -> Ref -> Ref -> m ()
shareBind1 lvl
    = sharePreaction (const id) (wrap fst) (wrap snd) Bind1Node Fanin lvl
  where
    wrap sel re r0 = do
        rn1 <- newNode $ const $ DupNode Fanout lvl re () () ()
...
shareBranch2B lvl0 lvl1 re opc nbt r0 r1 r2 r3 = case sharePreaction' nbt of
    Nothing -> copyIO3 Fanout Fanin lvl0 r0 r1 r2 r3 mk renamePreaction re nbt
    Just (name, sb) | null (B.bodyInstrs sb) -> do
        ...
        rn6 <- newNode $ const $ DupNode Fanout lvl0 re () () ()
        rn7 <- newNode $ const $ DupNode Fanin lvl0 re () () ()
        r8 <- w1 re' $ Ref rn4 0
        r9 <- w2 re' $ Ref rn5 0
        linkNodes (Ref rn4 1) (Ref rn6 1)
        linkNodes (Ref rn5 1) (Ref rn6 2)
    ...
    Just (name, sb) -> do
        ...
        rn8 <- newNode $ const $ DupNode Fanout lvl0 re () () ()
        rn9 <- newNode $ const $ DupNode Fanin lvl0 re () () ()
        r10 <- w1 re' (Ref rn6 0)
        r11 <- w2 re' (Ref rn7 0)
  ...
  where
    ...
    wrap sel re' r4 = do
        rn5 <- newNode $ const $ DupNode Fanout lvl0 re' () () ()
...
sharePreaction
    ...
    -> (Preaction -> () -> () -> INetF ())
    -> DupKind -> Level -> Renames -> Preaction -> Ref -> Ref -> Ref -> m ()
sharePreaction append w1 w2 mk dk lvl re nbs r0 r1 r2 = case sharePreaction' nbs of
    Nothing -> copyIO2 dk lvl r0 r1 r2 mk renamePreaction re nbs
    Just (name, sb) | null (B.bodyInstrs sb) -> do
        let mkPreaction rn = SimplePreaction (mkName rn) sb
        ...
        let re' = M.singleton name (mkRef t rn3, mkRef t rn4)
            t = B.instrType $ B.bodyTerm sb
        rn5 <- newNode $ const $ DupNode dk lvl (append re' re) () () ()
        r6 <- w1 re' $ Ref rn3 0
        r7 <- w2 re' $ Ref rn4 0
        linkNodes (Ref rn3 1) (Ref rn5 1)
        linkNodes (Ref rn4 1) (Ref rn5 2)
    ...
    Just (name, sb) -> do
        ...
        let re' = M.fromList $ zipWith (dupNames gop ltt rn5 rn6) [0..] names
        rn7 <- newNode $ const $ DupNode dk lvl (append re' re) () () ()
        r8 <- w1 re' (Ref rn5 0)
        r9 <- w2 re' (Ref rn6 0)
